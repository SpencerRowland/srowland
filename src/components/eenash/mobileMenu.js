...
const MobileMenu = () => (
    <nav id="menu">
        ...
        <section className="menu-section">
            ...
            <ul className="menu-section-list">
                <li>
                    <a rel="noopener noreferrer" href="https://www.tripadvisor.com/Attraction_Review-g55229-d9820229-Reviews-Escape_Experience_Nashville-Nashville_Tennessee.html" target="_blank">
                        <span className="menu-section-list-item menu-icon-1575"><FontAwesomeIcon icon={['fab', 'tripadvisor']}/>TripAdvisor</span>
                    </a>
                </li>
                <li>
                    <a href="https://www.yelp.com/biz/escape-experience-nashville-nashville" target="_blank" rel="noopener noreferrer">
                        <span className="menu-section-list-item menu-icon-105"><FontAwesomeIcon icon={['fab', 'yelp']}/>Yelp</span>
                    </a>
                </li>
                <li>
                    <a href="https://www.facebook.com/EscapeExperienceNashville/reviews" target="_blank" rel="noopener noreferrer">
                        <span className="menu-section-list-item menu-icon-875"><FontAwesomeIcon icon={['fab', 'facebook-f']}/>Facebook</span>
                    </a>
                </li>
                <li>
                    <a href="https://www.google.com/webhp?sourceid=chrome-instant&ion=1&espv=2&ie=UTF-8#q=escape%20experience%20nashville&lrd=0x8864665872ed33e7:0x20ff8e50dec3d247,1," target="_blank" rel="noopener noreferrer">
        ...
        <section className="menu-section">
            ...
            <ul className="menu-section-list">
                <li>
                    <a href="https://www.facebook.com/EscapeExperienceNashville/" target="_blank" rel="noopener noreferrer">
                        <span className="menu-section-list-item menu-icon-875"><FontAwesomeIcon icon={['fab', 'facebook-f']}/>Facebook</span>
                    </a>
                </li>
                <li>
                    <a href="https://www.instagram.com/escapeexperiencenashville/" target="_blank" rel="noopener noreferrer">
                        <span className="menu-section-list-item menu-icon-1225"><FontAwesomeIcon icon={['fab', 'instagram']}/>Instagram</span>
                    </a>
                </li>
                <li>
                    <a href="https://twitter.com/EscapeExpNash" target="_blank" rel="noopener noreferrer">
        ...
        <section className="menu-section">
            ...
            <ul className="menu-section-list">
                <li>
                    <a href="https://escapeexperience.com/chattanooga/" target="_blank" rel="noopener noreferrer">
